 ...
 * new/delete map on disk, to read a disk page into the buffer pool and pin
...
private:
  size_t pool_size_; // number of map in buffer pool
  Page *pages_;      // array of map
  DiskManager *disk_manager_;
  LogManager *log_manager_;
  HashTable<page_id_t, Page *> *page_table_; // to keep track of map
